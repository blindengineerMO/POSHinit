...
export const useAppStore = defineStore('app', {
  ...
  actions: {
    ...
    async workerControl() { return this.api('/api/workers') },
    async saveWorkerPool(pool) { return this.api('/api/worker-pools', { method: 'POST', body: JSON.stringify(pool) }) },
    async setWorkerDrain(id, draining) { return this.api(`/api/workers/${id}/drain`, { method: 'POST', body: JSON.stringify({ draining }) }) },
