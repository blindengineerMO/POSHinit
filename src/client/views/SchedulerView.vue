...
const scheduleDraft = reactive({ id: '', name: '', cadence: 'daily', startDate: today, runTime: '02:00', intervalDays: 1, weekdays: [1], timezone: 'UTC', enabled: true, requireApproval: false, scriptIds: [], groupIds: [], machineIds: [] })
...
function resetSchedule() {
  Object.assign(scheduleDraft, { id: '', name: '', cadence: 'daily', startDate: today, runTime: '02:00', intervalDays: 1, weekdays: [1], timezone: 'UTC', enabled: true, requireApproval: false, scriptIds: [], groupIds: [], machineIds: [] })
}
